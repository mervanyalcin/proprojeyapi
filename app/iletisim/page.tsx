...
import { MdError, MdErrorOutline, MdMailOutline } from 'react-icons/md'
        ...
        <Heading text='iletişim' />
          ...
          <div className="w-full flex">
            <div className="w-1/2 text-themeColorThird">
              ...
              <Link href={"https://www.instagram.com/prokastyapi/"} target='_blank' className=''>
                <div className="flex items-center my-4  border-themeColorSec rounded-lg p-4 hover:shadow-xl">
            ...
            <div className="w-1/2 text-themeColorThird">
              <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col gap-y-4'>
                ...
                <div className=''>
                  ...
                  })} className='border border-gray-300 text-gray-900 text-sm rounded-lg w-full p-2.5 focus:outline-none' placeholder='Buraya tam adınızı yazınız' />
                ...
                <button className="px-4 py-3 w-full border-2 hover:shadow-xl border-themeColorThird text-themeColorThird font-bold rounded-md  hover:text-themeColorOne hover:bg-themeColorThird transition-all">
                  Gönder
                </button>
